...
function SecuritySection() {
  const points = [
    ...
    { icon: <GitBranch className="h-4 w-4" />, title: "Read-only public demo", description: "Anonymous demo sessions are bound to a seeded organization; every write endpoint rejects demo-scoped tokens." },
  ...
  return (
    <section className="bg-brand-900">
      <Reveal className="mx-auto max-w-6xl px-4 py-16 text-center md:px-8">
        ...
        <div className="mt-6">
          <LinkButton href="/demo" size="lg" className="bg-white text-brand-900 hover:bg-brand-50">
            Explore Live Demo <ArrowRight className="h-4 w-4" />
          </LinkButton>
        </div>
      </Reveal>
